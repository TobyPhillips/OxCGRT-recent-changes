...
WorldChangeSIFortnightMap <- ggplot(GRIChangeMapData, aes(geometry=geometry)) +
  geom_sf(aes(fill=GRIChange)) +
  scale_fill_viridis(na.value = "grey90", name="Government Response Index Change") +
...
# The plot
png(filename =  "../images/changes-map.png", width = 600, height = 300)
...
# ggsave(file="../images/changes-map.png", width = 600, height = 300, units = "px", dpi = 300)
dev.off()
